...
<div class="container clearfix">
      <div id="top-menu">
        ...
        <a href="<?php  echo $host;  ?>" title="<?php  echo $name;  ?>-<?php  echo $title;  ?>" class="navimg clearfix">
          <img src="<?php  echo $zbp->Config('zbpNew')->logo;  ?>" alt="<?php  echo $name;  ?>-<?php  echo $title;  ?>">
          <span class="nav-title hide"><?php  echo $name;  ?></span>
        </a> 
